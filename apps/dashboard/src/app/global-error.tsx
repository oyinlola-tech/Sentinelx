    ...
    <html lang="en">
      <body style={{ background: "#0b1117", color: "#d7e1ea", fontFamily: "ui-sans-serif, system-ui", display: "grid", placeItems: "center", minHeight: "100dvh", margin: 0 }}>
        <main style={{ maxWidth: 420, padding: 24 }}>
          ...
          <button onClick={reset} style={{ marginTop: 16, background: "#8c9eff", color: "#0b1117", border: 0, borderRadius: 6, padding: "8px 14px", fontWeight: 500, cursor: "pointer" }}>Reload</button>
        </main>
      </body>
    </html>
  );
